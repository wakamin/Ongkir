                    ...
                    <fieldset>
                        ...
                        <?php foreach (sdokr_available_couriers() as $code => $courier): ?>
                            <label for="sdokr_tracking_courier_<?php echo esc_attr($code) ?>">
                                <input type="checkbox" id="sdokr_tracking_courier_<?php echo esc_attr($code) ?>" name="sdokr_tracking_couriers[]" value="<?php echo esc_attr($code) ?>" <?php checked(in_array($code, $activeCouriers)) ?>>
